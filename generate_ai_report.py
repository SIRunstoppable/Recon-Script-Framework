...
Check https://ai.google.dev/gemini-api/docs/models for the current list â€” model
...
<body><div class="container">
  <h1>ðŸ›¡ Attack Surface Report</h1>
  <div class="subtitle">Target: <b>{html.escape(domain)}</b> â€” Generated by Gemini</div>
...
def main():
    ...
    print(f"  â†’ sending recon summary to Gemini ({model}) for analysis...")
    ...
    print(f"  âœ“ AI report written to {out_path}")
